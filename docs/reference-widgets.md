...
Additional parameters can be added into [Paylet API](/apis#section-widget) to meet the additional requirements when building *payment page*. There are two main categories for additional parameters:
