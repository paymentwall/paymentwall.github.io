...
To deeplink to one of the payment methods below, you must pass an [optional parameter](/API-Reference#section-paylet-optional-parameter) ```ps``` with the payment system code as value, e.g. ```ps=cc``` for Credit Cards.
